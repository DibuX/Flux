...
/**
 * Convierte un usuario de la base de datos al formato de usuario de NextAuth.
 */
function convertToNextAuthUser(userFromDB: any): AdapterUser {
  return {
    id: userFromDB.id_usuario.toString(),
    name: `${userFromDB.nombre} ${userFromDB.apellido}`,
    email: userFromDB.email,
    emailVerified: ("emailVerified" in userFromDB) ? userFromDB.emailVerified : undefined,
  } as AdapterUser
}
