...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    if (newsletterForm) {
      // Fix: Use a standard event listener without 'this' typing
          ...
          <div className="container">
            <div className="brands-container">
              <div className="brand-logo">
                <img src="/img/brands/nike-logo.png" alt="Nike" />
              </div>
              <div className="brand-logo">
                <img src="/img/brands/adidas-logo.png" alt="Adidas" />
              </div>
              <div className="brand-logo">
                <img src="/img/brands/puma-logo.png" alt="Puma" />
              </div>
              <div className="brand-logo">
                <img src="/img/brands/reebok-logo.png" alt="Reebok" />
              </div>
              <div className="brand-logo">
                <img src="/img/brands/new-balance-logo.png" alt="New Balance" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="product-grid">
              <div className="product-card">
                <div className="product-image">
                  <img src="/img/products/nike-air-force-1.jpg" alt="Air Force 1 07" />
              ...
              <div className="product-card">
                <div className="product-image">
                  <img src="/img/products/nike-air-force-1-low-retro.jpg" alt="Air Force 1 Low Retro" />
                  <div className="product-actions">
                    <button className="action-btn">
                      <i className="fa-regular fa-heart"></i>
                    </button>
              ...
              <div className="product-card">
                <div className="product-image">
                  ...
                  <img src="/img/products/adidas-gazelle.jpg" alt="Gazelle Bold Liberty" />
                  <div className="product-actions">
                    <button className="action-btn">
                      <i className="fa-regular fa-heart"></i>
                    </button>
              ...
              <div className="product-card">
                <div className="product-image">
                  ...
                  <img src="/img/products/adidas-ultraboost.jpg" alt="Adidas UltraBoot" />
                  <div className="product-actions">
                    <button className="action-btn">
                      <i className="fa-regular fa-heart"></i>
                    </button>
          ...
          <div className="container">
            <div className="about-grid">
              <div className="about-image">
                <img src="/img/about/about-flux.jpg" alt="About Flux" />
            ...
            <div className="testimonials-grid">
              <div className="testimonial-card">
                ...
                <div className="testimonial-author">
                  <img src="/img/testimonials/testimonial-1.jpg" alt="María García" />
                  <div>
                    <h4>María García</h4>
              ...
              <div className="testimonial-card">
                ...
                <div className="testimonial-author">
                  <img src="/img/testimonials/testimonial-2.jpg" alt="Juan Pérez" />
                  <div>
                    <h4>Juan Pérez</h4>
              ...
              <div className="testimonial-card">
                ...
                <div className="testimonial-author">
                  <img src="/img/testimonials/testimonial-3.jpg" alt="Laura Rodríguez" />
                  <div>
